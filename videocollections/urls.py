"""videocollections URL Configuration
...
urlpatterns = [
    ...
    path('video/<int:pk>/delete',views.DeleteVideo.as_view(), name='delete_video'), #class based view cuz it linked with model and delete in the database
